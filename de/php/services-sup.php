    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted">
                    Obwohl es meist für eine neue Sportart gehalten wird, stellt das Stehpaddeln (auch Stand UpPaddling
                    bzw. SUP genannt) tatsächlich die früheste Form des Wellenreitens dar, die auf polynesische Fischer
                    zurückgeht. Vor zehn Jahren wurde diese alte Sportart auf Hawaii erfolgreich wiederbelebt, und hat
                    sich von dem ursprünglichen Wellenreiten über Freizeitpaddeln auf dem Brett, SUP Yoga und Reggatten
