    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">SPEZIAL PROGRAMM</h4>
            </div>
            <div class="modal-body">

                <h5 class="services-sm-title">Sportwoche</h5>

                <p class="text-muted text-justify">
                    In der <b>Sportwoche</b> vereinen wir alle Sportaktivitäten die im Angebot stehen. Jede Gruppe oder
                    Einzelperson kann mit dieser Option frei nach Wunsch alle verfügbaren Sportarten ausüben oder
                    einzelne Sportarten kombinieren.
                </p>
                <hr>

                <h5 class="services-sm-title">Teamentwicklung</h5>
                <p class="text-justify text-muted">
                    Wie in der Sportwoche, können auch <b>Teamentwicklungsmaßnahmen</b> mit Aktivitäten in allen
                    Sportarten die im Angebot stehendurchgeführt werden, sowie mit weiteren Aktivitäten, je nach
                    Absprache (z.B. Besuch im Abenteuerpark, Buggy- oderQuadfahrten,Seilrutschen, usw.).
