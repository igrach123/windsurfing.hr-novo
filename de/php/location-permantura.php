    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-muted">
                    Unser Windsurfzentrum in <strong>Premantura</strong> ist im Campingplatz Arena Stupicegelegen, in
                    dem auch Unterkunftsmöglichkeiten bereitstehen. Weitere Einzelheiten erfahren Sie unter
                    <a href="http://www.arenaturist.hr" target="_blank">www.arenaturist.hr</a>
                    <br>
                    <strong>Das Windsurfzentrum Premantura bietet auch Unterkunft in seinen Apartments in Premantura an.
                        Wir verfügen über zwei Apartments für je fünf und zwei Personen.</strong>
