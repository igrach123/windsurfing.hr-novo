<footer id="footer" class="clearfix">
            ...
            <div class="container">
                     ...
                     <div class="col-xs-12 col-sm-8 col-sm-offset-2  col-md-offset-3 col-md-6" id="contact-container">
                         ...
                         <div class="form-group">
                             <div class="text-center">
                                 <input id="submit" name="submit" type="submit" value="Senden" class="btn-send btn btn-primary btn-md">
                             </div>
                         </div>
                ...
                <div class="row footer-top clearfix">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3  footer-content ">
                        <h4 class=""> <span><i class="fa fa-caret-right"></i></span> NÜTZLICHE LINKS</h4>
                       <ul>
                            ...
                            <div class="footer-bottom-left"><a href="index.php" target="_self"> 
                             ...
                             <div class="footer-bottom-center">
                              ...
                              <div class="footer-bottom-right">   
                                  <a href="http://www.bookafriend.com.hr" target="_blank" > <p class="text-left hidden-xs izradio">Webmaster Igor B.</p></a>
                             </div>
