    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">POSEBNE PONUDE</h4>
            </div>
            <div class="modal-body">

                <h5 class="services-sm-title">SPORTSKI TJEDAN</h5>

                <p class="text-muted text-justify">
                    <strong>U sportskom tjednu</strong> cilju nam je objediniti sve sportove koje nudimo. Svaka grupa
                    ili pojedinac može izabrati ovakvu opciju, koja uključuje sve od navedene ponude ili izabrati
                    pojedine sportove ili varijante istoga.
                </p>
                <hr>
                ...
                <p class="text-justify text-muted">
                    ...
                    sportovima koje nudimo, a uz dogovor možemo dodati i druge aktivnosti po želji (adrenalinski
                    parkovi, vožnja buggyjem ili quodom, zip line, itd.)
                </p>
