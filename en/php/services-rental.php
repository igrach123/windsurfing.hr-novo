    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">SPECIAL PROGRAMM</h4>
            </div>
            <div class="modal-body">

                <h5 class="services-sm-title">SPORTS WEEK</h5>

                <p class="text-muted text-justify">
                    <strong>In the sports week</strong> we aim to combine all the sports activities we provide. Each
                    group or individual can choose this option, which may include any and all of our sports and
                    excursions, in any combination.
                </p>
                <hr>

                <h5 class="services-sm-title">TEAM BUILDING</h5>
                <p class="text-justify text-muted">
                    As in the sports week, we can also organize <strong>team
                        building</strong> with activities in all the sports we offer plus we can add other activities if
                    desired (visit to an adrenaline park, buggy or quod fun drives, zip line riding etc.)
