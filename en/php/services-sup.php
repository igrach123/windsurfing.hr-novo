        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted">
                    ...
                    very successfully revived this old sport, which developed from the original idea of wave riding,
                    through recreational SUP paddling, SUP yoga and SUP boarding races to white water paddling.
                ...
                <div class="row">
                    <div class="col-xs-offset-2 col-xs-8">
                        <div class="videoWrapper">
                            ...
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/8RNPewqloNw?showinfo=0"
                    ...
                    <div class="panel-body">
                        ...
                        <div id="links">
                            <div class="imgwrapper botmargin card-2">
                                <a href="../img/sup/s1.jpg" title="windsurfing">
                                    <img src="../img/sup/s1.jpg" data-src="../img/sup/s1.jpg"" class=" img
                                        img-responsive img-rounded " alt=" windsurf"></a>
                            </div>
                            <div class="imgwrapper botmargin card-2">
                                <a href="../img/sup/s2.jpg"" title=" windsurfing">
                                    <img src="../img/sup/s2.jpg"" data-src=" ../img/sup/s2.jpg""
                                        class="img img-responsive img-rounded " alt="windsurf"></a>
                            </div>
                            <div class="imgwrapper botmargin card-2">
                                <a href="../img/sup/s3.jpg"" title=" windsurfing">
                                    <img src="../img/sup/s3.jpg"" data-src=" ../img/sup/s3.jpg""
                                        class="img img-responsive img-rounded " alt="windsurf"></a>
                            </div>
                            <div class="imgwrapper botmargin card-2">
                                <a href="../img/sup/SUP3.jpg"" title=" windsurfing">
                                    <img src="../img/sup/SUP3.jpg"" data-src=" ../img/sup/SUP3.jpg""
                                        class="img img-responsive img-rounded " alt="windsurf"></a>
                            </div>
