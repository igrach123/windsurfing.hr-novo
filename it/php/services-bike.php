    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted">
                    Disponiamo di due punti di noleggio: a Premantura, sulla strada che porta verso il Campeggio
                    ArenaStupice, al numero civico 63 di fronte al Surf Bar e nel CampeggioArenaStupice. Disponiamo di
                    una vasta scelta di bici di diverse dimensioni e qualità.
                </p>
                ...
                <div class="row">
                    ...
                    <div class=" col-sm-6 col-md-3 col-xs-12">
                        <div class='card'>
                            <div class='front'>
                                <h6>TOUR PULA GIARDINO URBANO</h6>
                            ...
                            <div class='back'>
                                <b> <span>TOUR PULA GIARDINO URBANO inlcudee:</span></b>
                                <ul>
                                    <li>guida</li>
                                    <li>bicicletta</li>
                                    <li>pranzo</li>
                    ...
                    <div class=" col-sm-6 col-md-3 col-xs-12">
                        <div class='card'>
                            ...
                            <div class='back'>
                                <b> <span>TOUR ENDURO KAMENJAK inlcudee:</span></b>
                                <ul>
                                    <li>guida</li>
                                    <li>pranzo</li>
                                    <li>casco</li>
                        ...
                        <div class="card1">
                            <ul class="nav nav-tabs text-uppercase" role="tablist">
                                ...
                                <li role="presentation"><a href="#messages1" aria-controls="messages1" role="tab"
                                        data-toggle="tab">  <span>TOUR PULA GIARDINO URBANO</span></a></li>
                                <li role="presentation"><a href="#enduro" aria-controls="enduro" role="tab"
                                        data-toggle="tab">  <span>TOUR TOUR ENDURO KAMENJAK</span></a></li>
                            </ul>

                            <!-- Tab panes -->
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="home1">
                                    <b>L'escursione di mezza giornata in mountain bike ha due orari di partenza, alle
                                        09:00 e alle 13:00.</b>
                                    Le escursioni in mountain bike devono essere prenotate con almeno un giorno di
                                    anticipo.
                                    Si parte dal villaggio di Premantura, dal nostro centro al numero civico 63 (di
                                    fronte al Surf Bar). L’escursione di mezza giornatainizia sulla pista ciclabile
                                    lungo il paesaggio protetto di DonjiKamenjak, con sosta e visita al percorso dei
                                    dinosauri, seguita da una nuotata in una caletta appartata. Il ritmo dell'escursione
                                ...
                                <div role="tabpanel" class="tab-pane" id="profile1">
                                    ...
                                    anticipo.
                                    Si parte dal villaggio di Premantura, dal nostro centro al numero civico 63 (di
                                    fronte al Surf Bar). L’escursione di mezza giornata inizia sulla pista ciclabile
                                    lungo il paesaggio protetto di GornjiKamenjak, con sosta e visita al percorso dei
                                    dinosauri, seguita da una nuotata in una caletta appartata. Si prosegue seguendo le
                                    single trails del DonjiKamenjak con pausa pranzo al Safari Bar. Il ritmo
                                ...
                                <div role="tabpanel" class="tab-pane" id="messages1"><b>TOUR PULA GIARDINO URBANO</b>
                                    L'inizio del tour sul campo di Marte
                                    Prima fermata Verudela
                                    Tour di acquari o nuoto
                                    La seconda fermata Valovine
                                    Snorkeling nella grotta (grotte di colombi)
                                    Arena Arena terza tappa
                                    Il quarto forum di stop
                                    Fifth Stop Golden Gate
                                    Ritorna al campo di Marte

                                </div>
                                <div role="tabpanel" class="tab-pane" id="enduro"><b>TOUR TOUR ENDURO KAMENJAK</b>
                                    Questi tour sono per ciclisti esperti. Offrono una vera esperienza da mountain bike
                                    (sembra un sentiero di
                                    montagna), ma i sentieri corrono lungo la riva del mare, in una natura selvaggia e
                                    incontaminata. Il tour si
                                    percorre per lo più su single trails riducendo al minimo le strade asfaltate.
                                    Durata 5-8 h
                                    Chilometri 25-40
                                    Il prezzo include: pranzo, frutta, acqua, guida.
                    ...
                    <table class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">TOUR PULA GIARDINO URBANO</th>
                                <th scope="col">TOUR ENDURO KAMENJAK</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
