    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted">
                    Sebbene sia generalmente considerato un nuovo sport, il stand up paddling (SUP) è in realtà la prima
                    forma dello surf,originariamente concepito in Polinesia. Dieci anni fa, gli hawaiani hanno
                    riproposto con successo questo vecchio sport, che dall'idea originaria di scorrere sull'acqua in
                    piedi su una tavola e poter cavalcare le ondesi è sviluppata, con l’aiuto delle pagaie, attraverso
