...
<div id="location-permantura" class="modal fade" role="dialog" aria-labelledby="myModalLabel" tabindex="-1"
    role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-muted text-justify">
                    Premantura è un piccolo villaggio di pescatori sito sulla punta estrema della penisola istriana,
                    vicino alla riserva naturale di Kamenjak. Il Centro si trova nel Campeggio ArenaStupice, sul lato
                    orientale della penisola istriana, ed è quindi aperto ai venti più frequenti in questa zona: la
                    bora, il burin, lo scirocco e il maestrale.

                    I mesi più favorevoli per coloro che utilizzano le funboard sono certamente i mesi primaverili e
                    autunnali, quando la frequenza delle giornate ventose è maggiore (statisticamente il 65% dei
                    giorni). I mesi più favorevoli per iniziare a imparare il windsurf sono i mesi estivi, in cui l'aria
                    e l'acqua sono più calde e il vento più frequente è il maestrale.

                    Infine, i venti più forti provengono dal quadrante NNE-SSE, il che significa che se si verificano
                    delle avarie in mare, il vento non può che portarti a riva. Con questo aumentato grado di sicurezza
                    puoi tranquillamente goderti la surfata in tutto relax.
